...
class DiscordBuilder {
    ...
    fields(fields) {
        this._payload.embeds[0].fields = fields.map((entry) => {
            return Object.assign(Object.assign({}, entry), { inline: true });
        });
        return this;
    }
    buttons(buttons) {
        this._payload.components = [
            {
                ...
                components: buttons.map((entry) => {
                    return Object.assign({ type: 2, style: 1 }, entry);
                }),
            },
        ];
        return this;
...
exports.DiscordBuilder = DiscordBuilder;
...
exports.SlackBuilder = SlackBuilder;
...
exports.TeamsBuilder = TeamsBuilder;
...
const sendPayload = (url, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        core.debug(`Successfully sent payload to ${domain}. Webhook responded with: ${JSON.stringify(res)}`);
    }
    catch (err) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const discord_builder_1 = __nccwpck_require__(574);
const slack_builder_1 = __nccwpck_require__(6946);
const teams_builder_1 = __nccwpck_require__(4125);
const color_helper_1 = __nccwpck_require__(6325);
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const buttons = JSON.parse(core.getInput('buttons'));
        if (discordURL) {
            let discordPayload = new discord_builder_1.DiscordBuilder(color, title);
            if (text)
                discordPayload = discordPayload.text(text);
            if (fields)
        ...
        if (teamsURL) {
            ...
            if (text)
                teamsPayload = teamsPayload.text(text);
            if (fields)
        ...
        if (slackURL) {
            ...
            if (text)
                slackPayload = slackPayload.text(text);
            if (fields)
